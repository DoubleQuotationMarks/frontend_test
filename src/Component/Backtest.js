...
import Backtest_RSI from '../test/Backtest_RSI';
import Backtest_MACD from '../test/Backtest_MACD';
import Backtest_KD from '../test/Backtest_KD';
import Backtest_EMA from '../test/Backtest_EMA';
